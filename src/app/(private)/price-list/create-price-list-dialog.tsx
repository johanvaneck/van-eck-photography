...
import { PriceListForm } from "@/app/(private)/price-list/price-list-form";

export default function CreatePriceListDialog({ onCreate }: { onCreate: (data: { title: string; description: string; price: number }) => void | Promise<void> }) {
