...
export function EditStatusField({ shoot, updateShootAction }: { shoot: Shoot, updateShootAction: typeof updateShoot }) {
  ...
  return editing ? (
    ...
    <span onDoubleClick={() => setEditing(true)}>{shoot.status}</span>
  );
}
