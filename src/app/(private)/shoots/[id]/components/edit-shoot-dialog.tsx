...
import { Dialog, DialogHeader, DialogContent, DialogTitle, DialogFooter, DialogTrigger } from "@/components/ui/dialog";
...
export function EditShootDialog({ shoot, updateShootAction }: { shoot: Shoot, updateShootAction: typeof updateShoot }) {
    ...
    async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
        ...
        const deposit = depositRaw && depositRaw.toString().trim() !== "" ? parseFloat(depositRaw.toString()) : undefined;
        const price_charged = priceChargedRaw && priceChargedRaw.toString().trim() !== "" ? parseFloat(priceChargedRaw.toString()) : undefined;
        ...
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent>
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                    ...
                    <Input name="deposit" type="number" defaultValue={shoot.deposit?.toString() || ""} />
                    <Label htmlFor="price_charged">Price Charged</Label>
                    <Input name="price_charged" type="number" defaultValue={shoot.price_charged?.toString() || ""} />
